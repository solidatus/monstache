...
# 2026-07-23
MongoDB Go driver has 1 vulnerability CVE-2026-2303 which was fixed by upgrading go.mongodb.org/mongo-driver to v1.17.7, hence manually updated go.mod to use go.mongodb.org/mongo-driver v1.17.7 (latest on main branch was v1.11.4). The version of github.com/rwynn/gtm/v2 was bumped to v2.1.5 as a related package for go.mongodb.org/mongo-driver v1.17.7.
