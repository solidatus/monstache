...
Golang has 3 vulnerabilities: CVE-2026-42505, CVE-2026-39822, and CVE-2026-2303. CVE-2026-42505 and CVE-2026-39822 were fixed in 1.26.5, so go.mod was manually updated to use 1.26.5 (latest on main branch was 1.26.4). CVE-2026-2303 was fixed by explicitly pinning golang.org/x/net to v0.54.0 (alongside golang.org/x/crypto v0.52.0, golang.org/x/sys v0.45.0, golang.org/x/sync v0.20.0, and golang.org/x/text v0.37.0).
